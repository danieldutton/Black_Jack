...
//    {
//        private Mock<ICardSuitGenerator> _fakeCardDeckBuilder;
...
//        public void Init()
//        {
//            _fakeCardDeckBuilder = new Mock<ICardSuitGenerator>();
...
//            _fakeCardDeckBuilder.Verify(x => x.GenerateCardDeck(), Times.Once());
//        }
...
//            _fakeCardDeckBuilder.Setup(x => x.GenerateCardDeck())
//                .Returns(() => cardQueue);
